...
import SeeStatistics from "./SeeStatistics";
import EditStatistic from "./EditStatistics";
      ...
      renderCell: (params) => {
        ...
        return (
          <Box sx={{ display: "flex", justifyContent: "center" }}>
            <SeeStatistics data={rowData} onSuccess={handleRefresh} />
            <EditStatistic data={rowData} onSuccess={handleRefresh} />
            <DeleteButton
              type={"statistics"}
              id={rowData}
  ...
  return (
    <PageContainer title="Статистик" description="Статистик">
      <Box sx={{ height: 400, width: "100%" }}>
        ...
        >
          <AddStatistic onSuccess={handleRefresh} />
        </Box>
